                                            ...
                                            <div class="col-md-8">
                                                <div class="card">
                                                 ...
                                                 <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                    <img src="/Profile/{{ $users->images }}" class="rounded" style="max-height: 100px; max-width: 100px;" alt="" srcset="">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input id="password" type="password"value="{{ md5($users->password) }}" class="form-control @error('password') is-invalid @enderror" placeholder="••••••••" name="password_confirmation" required autocomplete="new-password">
...
<a href="/user" class="btn btn-outline-primary fe-16">ย้อนกลับ</a>
                                                                &nbsp;&nbsp;
