...
{{-- /studenthome/updateuser2/{{Auth::user()->id}} --}}
                                                ...
                                                <div class="d-grid gap-2 d-md-flex   ">
                                                    <a href="/adminhome"  class="btn btn-outline-primary fe-16" type="button">ย้อนกลับ</a>
                                                    &nbsp;&nbsp;
                                                    {{-- <a href="/studenthome/updateuser2/{{Auth::user()->id}}"name="next" class="btn btn-outline-success me-md-2 success btn2" onclick="return confirm('แน่ใจจะยืนยันตัวตน?')"  type="button">ยืนยันข้อมูล</a> --}}
                                                      ...
                                                      <a href="/admin/edituser0004/{{Auth::user()->id}}"  class="btn btn-outline-primary fe fe-edit fe-16" type="button">เปลี่ยนรหัสผ่าน</a>
                                                      &nbsp;&nbsp;
                                                      ...
                                                      <a href="/admin/edituser04/{{Auth::user()->id}}"  class="btn btn-outline-warning fe fe-edit fe-16" type="button">แก้ไขข้อมูล</a> </div>
                                                </div>
                                                    </div>
                                            </div> <!-- / .card -->
                                          </div>
