    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content ">
        <div class="modal-header bg-dark text-white ">
          <h5 class="modal-title text center " id="varyModalLabel">แก้ไขข้อมูล หลักสูตรสาขา</h5>
          {{-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button> --}}
        </div>
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="{{url('/officer/updatmajor/'.$major->major_id)}}"enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
        ...
        <br>
            <div class="modal-footer">
              <a href="/officer/major" type="submit" class="btn mb-2 btn-secondary" >ย้อนกลับ</a>
