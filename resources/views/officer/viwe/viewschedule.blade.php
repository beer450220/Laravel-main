              ...
              <div class="modal-content ">
                ...
                <div class="modal-body">
                  ...
                  <form method="POST" action="">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <label for="recipient-name" class="col-form-label">หัวเรื่อง</label><br>
                    ...
                    <br>
                        ...
                        <div class="col-md-4">
                          ...
                          <textarea  rows="4" cols="50" name="em_job" disabled readonly >  {{$establishments->details}}
                        </textarea>
                ...
                <div class="modal-footer">
                  ...
                  <a href="/officer/schedule" class="btn mb-2 btn-primary">ย้อนกลับ</a>
                </div></form>
              </div>
            </div>
          </div>
