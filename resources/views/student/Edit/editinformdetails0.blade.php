...
@endif
                                            <strong class="card-title">แก้ไขรายงานสถานะการเข้าปฏิบัติงาน</strong>
                                          </div>
...
{{$informdetails->files}}
                                                  ...
                                                  <input type="hidden" id="custId" name="namefile" value="{{$informdetails->namefile}}">
                                                {{--  @error('filess')
...
@for ($i = $endYear; $i >= $startYear; $i--)
    @for ($j = 1; $j <= 1; $j++)
        <option value="{{ $i }}"@if($informdetails->year==$i ) selected @endif>{{ $i }}</option>
    @endfor
@endfor
</select>    </div>
                                                  ...
                                                  <div class="form-group mb-3">
                                                      ...
                                                      <option value="ภาคเรียนที่1"@if($informdetails->term=="ภาคเรียนที่1") selected @endif>ภาคเรียนที่:1 </option>
                                                        <option value="ภาคเรียนที่2"@if($informdetails->term=="ภาคเรียนที่2") selected @endif>ภาคเรียนที่:2 </option>
                                                      </select>
                                                  </div>
                                            </div>
