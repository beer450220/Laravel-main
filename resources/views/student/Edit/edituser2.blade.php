                                                ...
                                                <div class="row">
                                                  <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                      <form method="POST"id="myForm" action="{{url('/studenthome/updatepersonal2/'.$users->id)}}" enctype="multipart/form-data">
                                                        @csrf
                                                    ...
                                                    <div class="form-group mb-3">
                                                      ...
                                                      <input type="email" id="example-palaceholder"value="{{ $users->email}}"name="email"  class="form-control"required placeholder="">
                                                    </div>
                                                    <div class="form-group mb-3">
                                                  ...
                                                  <div class="col-md-8">
                                                    ...
                                                    {{-- <div class="form-group col-4">
                                                        ...
                                                        $endYear = $currentYear + 2; // ปีสิ้นสุด
                                                    @endphp
