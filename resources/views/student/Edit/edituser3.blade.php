                                                ...
                                                <div class="row">
                                                  <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                      <form method="POST"id="myForm" action="{{url('/studenthome/updatepersonal4/'.$users->id)}}" enctype="multipart/form-data">
                                                        @csrf
                                                    ...
                                                    <div class="form-group mb-3">
                                                      ...
                                                      <input type="text" id="example-palaceholder"value="{{ $users->em_telephone}}"name="em_telephone"maxlength="10"  class="form-control"required placeholder="">
                                                    </div>
                                                    <div class="form-group mb-3">
