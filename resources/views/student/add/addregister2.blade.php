...
@endif
                                          ...
                                          <form method="POST"id="myForm" action="{{ route('addregisteruser2') }}"enctype="multipart/form-data" >
                                            @csrf
                                                  ...
                                                  <input type="hidden" id="custId" name="namefile" value="ใบสมัครงานสหกิจศึกษา(สก03)">
                                                </div>
                                                <div class="form-group mb-3">
