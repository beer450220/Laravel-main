...
@endif
                                          ...
                                          <form method="POST"id="myForm" action="{{ route('addregisteruser3') }}"enctype="multipart/form-data" >
                                            @csrf
                                                  ...
                                                  <input type="hidden" id="custId" name="namefile" value="แบบคำรองขอหนังสือขอความอนุเคราะหรับนักศึกษาสหกิจศึกษา(สก04)">
                                                </div>
                                                <div class="form-group mb-3">
