                ...
                <form id="msform">
                    ...
                    <ul id="progressbar">
                      ...
                      <a  href="/studenthome/establishmentuser">  <li class="active" id="personal"><strong>สถานประกอบการ</strong></li></a> --}}
                        <a  href="/studenthome/register">  <li class="active" id="payment"><strong>ลงทะเบียนนักศึกษา
...
@endif
                                          ...
                                          <form method="POST"id="myForm" action="{{ route('addregisteruser7') }}"enctype="multipart/form-data" >
                                            @csrf
                                                  ...
                                                  <input type="hidden" id="custId" name="namefile" value="ประวัติส่วนตัว(resume)">
                                                </div>
                                                <div class="form-group mb-3">
