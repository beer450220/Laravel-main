...
@endif
                                            <strong class="card-title">เพิ่มข้อมูลรายงานผลการฝึกประสบการณ์</strong>
                                          </div>
                                          ...
                                          <form method="POST" action="{{ route('addreportuser3') }}"enctype="multipart/form-data" >
                                            @csrf
                                                  ...
                                                  <input type="hidden" id="custId" name="namefile" value="PowerPoint การนำเสนอ">
                                                </div>
                                                <div class="form-group mb-3">
