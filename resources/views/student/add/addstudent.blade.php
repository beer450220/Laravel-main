                                    ...
                                    <div class="row justify-content-center">
                                      <div class="col-7">
                                        ...
                                        <div class="card shadow mb-4">
                                          ...
                                          <form method="POST" action="{{ route('addstudent1') }}" >
                                            @csrf
                                                ...
                                                <div class="form-group mb-3">
                                                  <label for="example-email">หลักสูตรสาขา</label>
                                                  <input type="text" id="example-email"  name="fname" class="form-control" placeholder="">
                                                </div>
                                                <div class="form-group mb-3">
                                                  ...
                                                  <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" id="example-palaceholder"value=""  class="form-control" placeholder="">
                                                  </div>
                                            </div> <!-- /.col -->
                                              <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                  <label for="example-helping">ชื่อ-นามสกุล</label>
                                                  <input type="text" id="example-helping"value="{{ Auth::user()->address }}" disabled="" class="form-control" placeholder="">

                                                </div>
                                                <div class="form-group mb-3">
                                                  <label for="example-readonly">	เบอร์โทรศัพท์</label>
                                                  <input type="text" id="example-readonly"value=""  class="form-control" readonly="" value="Readonly value">
                                                </div>
                                                <div class="form-group mb-3">
                                                  <label for="example-disable">คณะ</label>
                                                  <input type="text" class="form-control"value=""  id="example-disable" disabled="" value="Disabled value">
                                                </div>
...
{{-- /studenthome/updateuser2/{{Auth::user()->id}} --}}
                                            ...
                                            <div class="card shadow mb-4">
                                                <div class="card-header">
                                                  <strong class="card-title">ข้อมูลที่อยู่</strong>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                      <div class="col-md-6">
                                                  ...
                                                  {{-- <form method="POST" action="{{url('/studenthome/updateuser2/'.Auth::user()->id)}}" enctype="multipart/form-data">
                                                    @csrf --}}
                                                          <label for="simpleinput">บ้านเลขที่/หมู่/ถนน</label>
                                                          <input type="text"value=""  id="simpleinput" class="form-control">
                                                        </div>
                                                        <div class="form-group mb-3">
                                                          <label for="example-email">อำเภอ</label>
                                                          <input type="email" id="example-email"value=""  name="example-email" class="form-control" placeholder="">
                                                        </div>
                                                        <div class="form-group mb-3">
                                                          <label for="example-password">รหัสไปรษณีย์</label>
                                                          <input type="password" id="example-password" class="form-control" value="">
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                      <label for="example-helping">ตำบล</label>
                                                      <input type="text" id="example-helping"value=""  class="form-control" placeholder="">
                                                      <div class="form-group mb-3">
                                                        <label for="example-readonly">	จังหวัด</label>
                                                        <input type="text" id="example-readonly"value=""  class="form-control" readonly="" value="">
                                                      </div>
                                            ...
                                            <div class="card shadow mb-4">
                                                <div class="card-header">
                                                  <strong class="card-title">ข้อมูลผู้ปกครอง</strong>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                      <div class="col-md-6">
                                                  ...
                                                  {{-- <form method="POST" action="{{url('/studenthome/updateuser2/'.Auth::user()->id)}}" enctype="multipart/form-data">
                                                    @csrf --}}
                                                          <label for="simpleinput">ชื่อผู้ปกครอง</label>
                                                          <input type="text"value=""  id="simpleinput" class="form-control">
                                                        </div>
                                                        <div class="form-group mb-3">
                                                          <label for="example-email">เบอร์โทรผู้ปกครอง</label>
                                                          <input type="text" id="example-email"value= "" name="example-email" class="form-control" placeholder="">
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                      <label for="example-helping">ความเกี่ยวข้อง</label>
                                                      <input type="text" id="example-helping"value=""  class="form-control" placeholder="">
                                                      <div class="form-group mb-3">
                                                        <label for="example-readonly">	ที่อยู่ผู้ปกครอง</label>
                                                        <input type="text" id="example-readonly"value=""  class="form-control" readonly="" value="Readonly value">
                                                      </div>
