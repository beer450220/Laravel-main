                        ...
                        <div class="form-card">
                            <div class="row">
                              ...
                              <div class=" alert alert-primary  " role="alert">
                                  <b>ขั้นตอนที่ 4 รายงานสถานะการเข้าปฏิบัติงาน:</b> ดาวน์โหลดเอกสาร
                                  <br>แบบแจ้งรายละเอียดการปฏิบัติงาน(สก.07)
                                      <br>แบบแจ้งแผนปฏิบัติงานสหกิจศึกษา(สก.08)
                                      <br>แบบแจ้งโครงร่างรายงานการปฏิบัติงานสหกิจศึกษา(สก.09)
                                      <br>
                                      <br>  <a href="/studenthome/informdetails"  class="btn btn-outline-warning " type="button">>คลิกที่นี่<</a>เพื่อย้อนกลับ
                                                              </div>   <br>   <br>
                          </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                     ...
                     <td></td>
                     <td></td>
                     <td><a href="/ไฟล์เอกสารดาวน์โหลด/สก.07.pdf" target="_BLANK"><i class="fe fe-arrow-down-circle fe-24"></i></a></td>
{{-- download --}}
                    </tr>
                    <tr>
