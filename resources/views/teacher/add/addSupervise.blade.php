...
@endif
                                   ...
                                   <strong class="card-title">รายงานผลการนิเทศงาน</strong>
                                          ...
                                          <form method="POST" action="{{ route('addSuperviseteacheruser') }}"enctype="multipart/form-data" >
                                            @csrf
                                                  ...
                                                  <input type="hidden" id="custId" name="namefile" value="แบบบันทึกการนิเทศงานสหกิจศึกษา(สก12)">
                                                </div>
                                                <div class="form-group mb-3">
