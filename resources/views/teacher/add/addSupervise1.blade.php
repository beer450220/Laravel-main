                ...
                <form id="msform">
                    ...
                    <ul id="progressbar">
                      ...
                      {{-- <a  href="/studenthome/establishmentuser">  <li class="active" id="personal"><strong>สถานประกอบการ</strong></li></a>
                        ...
                        <a  href="/teacher/calendar5confirm"> <li id="confirm" class="active"><strong>นิเทศงาน</strong></li></a>
                    ...
                    <fieldset>
                        <div class="form-card">
                            <div class="row">
                                <div class="col-7">
                                    <h2 class="fs-title col">รายงานผลการนิเทศงาน:</h2>
...
@endif
                                   ...
                                   <strong class="card-title">รายงานผลการนิเทศงาน</strong>
                                          </div>
                                          ...
                                          <form method="POST" action="{{ route('addSuperviseteacheruser1') }}"enctype="multipart/form-data" >
                                            @csrf
                                                  ...
                                                  <input type="hidden" id="custId" name="namefile" value="แบบประเมินรายงานนักศึกษาสหกิจศึกษา(สก15)">
                                                </div>
                                                <div class="form-group mb-3">
                                              ...
                                              {{-- <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                  ...
                                                  <div class="custom-file">
                                                    ...
                                                    <a href="/teacher/calendar5confirm" type="submit" class="btn mb-2 btn-secondary" >ย้อนกลับ</a>
                                                  </div></form>
                                                <div class="form-group mb-3">
