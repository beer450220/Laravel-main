...
@endif
                                            <strong class="card-title">นิเทศงาน</strong>
                                          </div>
                                          ...
                                          <form method="POST" action="{{url('/teacher/update1/'.$establishments->id)}}"enctype="multipart/form-data" >
                                            @csrf
                                                  ...
                                                  <div class="form-group mb-3">
                                                    ...
                                                    <div class="custom-file">
                                                        <div class="custom-file">
                                                            ...
                                                            <img src="/ไฟล์เอกสารประเมิน(สก.15)/{{ $establishments->filess }}" class="img-responsive" style="max-height: 100px; max-width: 100px;" alt="" srcset="">
