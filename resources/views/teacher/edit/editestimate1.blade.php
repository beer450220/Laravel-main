  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content ">
      <div class="modal-header text-white ">
        <h5 class="modal-title text center " id="varyModalLabel">แก้ไขข้อมูล เอกสารผลประเมินสหกิจศึกษา</h5>
...
<div class="row">
  <div class="col-md-12">
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form method="POST" id="myForm" action="{{url('/studenthome/updateestimate1/'.$supervisions->supervision_id)}}"enctype="multipart/form-data">
          @csrf
          @if ($errors->any())
