...
<br>
                      ...
                      <tr>
                        ...
                        @endif</td> --}}
                        <td>
                            <a href="../../document4/{{ $row->filess }}" target="_BLANK" class="btn btn-outline-primary fa-regular fa-circle-down"></a>
                        </td>
        ...
        <script>
            function toggleSelectAll(source) {
                ...
                <div class="modal-footer">
                  ...
                  <a href="/teacher/report04"  class="btn mb-2 btn-secondary" data-dismiss="modal">ย้อนกลับ</a>
